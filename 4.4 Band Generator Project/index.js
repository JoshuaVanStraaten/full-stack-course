...
// Use Middleware to set static resource path.
...
app.post("/submit", (req, res) => {
  ...
  var randAdjIdx = Math.floor(Math.random() * adj.length);
  var randNounIdx = Math.floor(Math.random() * noun.length);
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", {randomAdj: adj[randAdjIdx],
                           randomNoun: noun[randNounIdx], year: currentYear});
